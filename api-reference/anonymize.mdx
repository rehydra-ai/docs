...
interface AnonymizationResult {
  ...
  entities: Array<{
    ...
    semantic?: {
      ...
      scope?: 'city' | 'country' | 'region' | 'unknown';
      title?: string;
    };
  }>;
  piiMap?: {   // undefined when mode is 'anonymize'
    ciphertext: string;
    iv: string;
    authTag: string;
  };
...
// Keep countries visible (requires semantic: { enabled: true })
await anonymizer.anonymize('Meeting in Berlin, Germany.', undefined, {
