...
<CardGroup cols={2}>
  ...
  <Card title="LLM Proxy" icon="server">
    Drop-in proxy middleware for OpenAI and Anthropic with automatic PII handling
  </Card>
  <Card title="Streaming" icon="wave-pulse">
    Stream-based anonymization for real-time LLM output and chunked text
  </Card>
  <Card title="CLI Tool" icon="terminal">
    Anonymize, rehydrate, and inspect PII directly from the terminal
  </Card>
</CardGroup>
